...
export class MonticuloMaximo {
  ...
  push(cancion: Cancion): void {
    ...
    this.percolarArriba(this.elementos.length - 1);
  }
  ...
  private percolarArriba(indice: number): void {
    while (indice > 0) {
  ...
  private percolarAbajo(indice: number): void {
    while (true) {
